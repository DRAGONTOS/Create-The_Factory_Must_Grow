...
public class TFMGTags {
    ...
    public enum TFMGItemTags {
        ...
        DUSTS_COPPER(COMMON, "dusts/copper"),
        DUSTS_SALTPETER(COMMON, "dusts/saltpeter"),
        DUSTS_SULFUR(COMMON, "dusts/sulfur"),
        SODIUM_METAL(COMMON, "ingots/sodium_metal"),
        SODIUM_BICARBONATE(COMMON, "dusts/sodium_bicarbonate"),
        CUPRIC_CHLORIDE(COMMON, "dusts/cupric_chloride"),
        FLUX,
    ...
    public enum TFMGFluidTags {
        ...
        HYDROCHLORIC_ACID(COMMON),
        ACETALDEHYDE(COMMON),
        BUTYRALDEHYDE(COMMON),
        ETHYLHEXANOL(COMMON),
        CETANE_IMPROVER(COMMON),
